...
function Wo_GetCommonUsers($args = array()) {
    ...
    if (!empty($wo['user']['address'])) {
        ...
        if (!empty($sub_sql)) {
            ...
            $sub_sql .= " OR `address`  = '" . $wo['user']['address'] . "' ";

        } else {

            $sub_sql .= " `address`  = '" . $wo['user']['address'] . "' ";
    ...
    if ($query && mysqli_num_rows($query)) {
        ...
        while ($fetched_data = mysqli_fetch_assoc($query)) {
            ...
            if (!empty($wo['user']['address']) && !empty($fetched_data['user_data']['city']) && $wo['user']['address'] == $fetched_data['user_data']['address']) {
